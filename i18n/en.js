...
LANG_EN.inv_btn_own_template = 'Custom template';
LANG_EN.inv_btn_duplicate_template = 'Duplicate';
LANG_EN.inv_btn_dictionaries = 'Dictionaries';
...
LANG_EN.inv_tpl_empty_editor_hint = 'No columns yet. Use «add field» below: set the column title and type (text, number, select, date, yes/no).';
...
LANG_EN.inv_field_type_multi_select = 'Multi-select';
LANG_EN.inv_field_type_composite = 'Composite ID';
LANG_EN.inv_field_select_source = 'Value source';
LANG_EN.inv_field_source_options = 'Custom list';
LANG_EN.inv_field_source_dictionary = 'Dictionary';
LANG_EN.inv_field_dictionary_pick = 'Dictionary';
LANG_EN.inv_field_unit_mode = 'Unit';
LANG_EN.inv_field_unit_none = 'None';
LANG_EN.inv_field_unit_free = 'Custom label';
LANG_EN.inv_field_unit_dictionary = 'From dictionary';
LANG_EN.inv_field_unit_dictionary_short = 'u.';
LANG_EN.inv_field_composite_sep = 'Part separator';
LANG_EN.inv_field_composite_parts = 'Part labels';
LANG_EN.inv_field_no_options = 'No options. Set a list in the template or fill the dictionary.';
LANG_EN.inv_composite_part_default1 = 'Part 1';
LANG_EN.inv_composite_part_default2 = 'Part 2';
LANG_EN.inv_composite_part_default_short = 'Part';
...
LANG_EN.inv_tpl_copy_suffix = ' (copy)';
