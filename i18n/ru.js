...
LANG_RU.inv_btn_dictionaries = 'Справочники';
...
LANG_RU.inv_modal_rename_record_title = 'Переименовать опись';
...
LANG_RU.inv_field_type_multi_select = 'Несколько из списка';
LANG_RU.inv_field_type_composite = 'Составной номер';
LANG_RU.inv_field_select_source = 'Источник значений';
LANG_RU.inv_field_source_options = 'Свой список';
LANG_RU.inv_field_source_dictionary = 'Справочник';
LANG_RU.inv_field_dictionary_pick = 'Справочник';
LANG_RU.inv_field_unit_mode = 'Единица измерения';
LANG_RU.inv_field_unit_none = 'Нет';
LANG_RU.inv_field_unit_free = 'Своя подпись';
LANG_RU.inv_field_unit_dictionary = 'Из справочника';
LANG_RU.inv_field_unit_dictionary_short = 'ед.';
LANG_RU.inv_field_composite_sep = 'Разделитель частей';
LANG_RU.inv_field_composite_parts = 'Подписи частей номера';
LANG_RU.inv_field_no_options = 'Нет вариантов. Укажите список в шаблоне или заполните справочник.';
LANG_RU.inv_composite_part_default1 = 'Часть 1';
LANG_RU.inv_composite_part_default2 = 'Часть 2';
LANG_RU.inv_composite_part_default_short = 'Часть';
...
LANG_RU.inv_dict_name_input_placeholder = 'Например: Типы крепежа';
LANG_RU.inv_err_dict_name_required = 'Укажите название справочника';
